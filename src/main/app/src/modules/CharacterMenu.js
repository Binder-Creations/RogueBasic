  ...
  render(){
    ...
    return(
      <div key="menu" className="menu">
        ...
        <input className="btn-close hover-saturate" type="image" src={this.props.props.images.buttonClose} alt="Close" onClick={() => this.props.props.appState("menu", "character")}/>
