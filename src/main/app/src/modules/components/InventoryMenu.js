...
class InventoryMenu extends React.Component {
  ...
  constructor(props){
    ...
    if(this.props.s.pc.characterClass === "Rogue"){
      this.silhouette = this.props.c.images.silhouetteRogue;
      this.silhouetteClass = "silhouette-rogue";
    } else if(this.props.s.pc.characterClass === "Wizard"){
      this.silhouette = this.props.c.images.silhouetteWizard;
      this.silhouetteClass = "silhouette-wizard";
    } else {
      this.silhouette = this.props.c.images.silhouetteWarrior;
  ...
  render(){
    return(
      <div key="menu" className="menu">
        <img className="background" src={this.props.c.images.inventoryMenu} alt="Inventory Screen"/>
        <img className={this.silhouetteClass} src={this.silhouette} alt={this.props.s.pc.characterClass}/>
        <input className="btn-close hover-saturate" type="image" src={this.props.c.images.buttonClose} alt="Close" onClick={() => this.props.c.menu("inventory")}/>
