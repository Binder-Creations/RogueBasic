    ...
    let update = this.props.s.gameOver;
      return(
        <div className="death-menu">
          <img className="background" src={this.props.c.images.common.deathMenu} alt="Quest Screen"/>
          ...
          <div className="btn-death hover-saturate">
            <input className="background" type="image" src={this.props.c.images.common.buttonDeath} alt="Accept Fate" onClick={() => this.props.c.endGame()}/>
