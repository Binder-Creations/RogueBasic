        ...
        return(
          <>
            <div className="btn-atr con hover-saturate">
              <input className="background" type="image" src={c.images.common.buttonConstitution} alt="Constitution" onClick={()=>{c.pointbuy("constitution", 1)}}/>
              <p className="v-h-centered nopointer">
                +Con
              </p>
            </div>
            <div className="btn-atr str hover-saturate">
              <input className="background" type="image" src={c.images.common.buttonStrength} alt="Strength" onClick={()=>{c.pointbuy("strength", 1)}}/>
              <p className="v-h-centered nopointer">
                +Str
              </p>
            </div>      
            <div className="btn-atr dex hover-saturate">
              <input className="background" type="image" src={c.images.common.buttonDexterity} alt="Dexterity" onClick={()=>{c.pointbuy("dexterity", 1)}}/>
              <p className="v-h-centered nopointer">
                +Dex
              </p>
            </div> 
            <div className="btn-atr int hover-saturate">
              <input className="background" type="image" src={c.images.common.buttonIntelligence} alt="Intelligence" onClick={()=>{c.pointbuy("intelligence", 1)}}/>
              <p className="v-h-centered nopointer">
                +Int
              </p>
            </div>
