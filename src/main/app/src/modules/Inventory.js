...
class Inventory extends React.Component {
  ...
  pushTableUsable(item){
    let itemProps = this.props.props.itemServices.getProps(item);
    this.itemList.push(
        <tr className="shop-box-item" onClick={()=>{this.props.props.appState(this.props.type, item, 0)}} style={{backgroundImage: `url(${this.props.props.images.tableBackground})`, height: window.innerWidth*0.0631 + "px"}}>
