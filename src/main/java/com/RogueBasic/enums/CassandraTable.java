...
public enum CassandraTable {
	PLAYER(" (id uuid PRIMARY KEY, name text, passwordHash blob, salt blob, characterIds set<UUID>, metacurrency int, constitutionMetabonus int, strengthMetabonus int, intelligenceMetabonus int, dexterityMetabonus int, currencyMetabonus int)"),
